...
const ProductDetail = () => {
  ...
  return (
    <SingleProduct>
      ...
      <div className="contact-wrapper py-1 home-wrapper">
        <div className=" product-content">
          ...
          {/* ******PRODUCT WRITE UP************* */}
          <div className="product-write-up">
            <h2 className="product-name">SAMSUNG TABLET 2023</h2>
      ...
      <div className="description page-container py-5">
        ...
        <p className="desc-content">
          ...
          neque inventore quidem dolores molestiae vel eos! Eius mollitia velit
          porro? Maxime quidem ducimus, ex voluptates eaque consectetur nemo
          ipsam a veritatis porro error impedit quasi, possimus animi culpa
          veniam ratione nulla sapiente. Inventore perferendis nisi laboriosam
          porro quibusdam est dicta dolorum? Aut beatae qui omnis laudantium
          impedit rem, iste officia voluptatum sequi saepe quos animi
          reprehenderit error numquam iure pariatur. Ipsa praesentium
          ...
          architecto sapiente delectus distinctio, ad nemo pariatur esse dolores
          sequi sit voluptas quidem quaerat. Quisquam repellendus, eius
          distinctio aliquam deleniti deserunt nulla repudiandae ipsum suscipit
          adipisci accusamus cum quo ipsa itaque minima amet eveniet nihil
          quibusdam quasi explicabo aliquid unde aspernatur eos id? Suscipit
          tenetur ipsum, facilis unde dicta, accusamus dolorem
        </p>
      </div>
      <ReviewForm />
      <YouMayLike />
